...
@always_inline
fn _radix_n_fft_kernel_exp_twfs_runtime[
    in_dtype: DType,
    out_dtype: DType,
    in_layout: Layout,
    out_layout: Layout,
    ...
    *,
    ...
    for j in range(UInt(1), base):
        ...
        var i0_j_twf = _get_twiddle_factor[
...
@always_inline
fn _radix_n_fft_kernel_exp_no_params[
    in_dtype: DType,
    out_dtype: DType,
    in_layout: Layout,
    out_layout: Layout,
    ...
    *,
    ...
    for j in range(UInt(1), base):
        ...
        for i in range(base):
            x_out.store(Int(i), 0, to_CoV(i0_j_twf.fma(x_j, x_0)))
